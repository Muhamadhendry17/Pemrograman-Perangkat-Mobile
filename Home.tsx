        ...
        <View>
          <LinearGradient
            ...
            <View
              ...
              <Image
                source={require('./src/assets/Hendry.jpg')}
                resizeMode={'stretch'}
                style={{
                  borderRadius: 14,
                  width: 44,
            ...
            <View style={{flexDirection: 'row'}}>
              <View
                ...
                <ImageBackground
                  ...
                  <View
                    ...
                    <Image
                      source={require('./src/assets/five-stars.png')}
                      resizeMode={'stretch'}
                      style={{
                        width: 15,
                        height: 15,
              ...
              <View
                ...
                <ImageBackground
                  source={{
                    uri: 'https://waroengsteakandshake.com/img/img_menu/Cappucino.png',
                  }}
                  resizeMode={'stretch'}
                  imageStyle={{borderRadius: 16}}
            ...
            <View style={{flexDirection: 'row'}}>
              <View
                ...
                <ImageBackground
                  source={{
                    uri: 'https://pbs.twimg.com/media/GTFzC6_XsAEgznQ.jpg',
                  }}
                  resizeMode={'stretch'}
                  imageStyle={{borderRadius: 16}}
                  style={{height: 132, marginBottom: 14}}>
            ...
            <View style={{flexDirection: 'row'}}>
              <View
                ...
                <ImageBackground
                  source={{
                    uri: 'https://cdn.kerbel.in/assets/product/product_IDVGUOCHLR_1664033686_1.webp',
                  }}
                  resizeMode={'stretch'}
                  imageStyle={{borderRadius: 16}}
                  style={{height: 132, marginBottom: 14}}>
              ...
              <View
                ...
                <ImageBackground
                  source={{
                    uri: 'https://media-cdn.tripadvisor.com/media/photo-s/1a/af/f3/fe/cappucino-a-cappuccino.jpg',
                  }}
                  resizeMode={'stretch'}
                  imageStyle={{borderRadius: 16}}
                  style={{height: 132, marginBottom: 14, marginLeft: 10}}>
